...
describe("GET '/place'", () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const firstSaveResult = yield firstPlace.save();
        const secondSaveResult = yield secondPlace.save();
    ...
    describe("Given that I wish to get place data with an id", () => {
        describe("When I GET on /place with a valid id as data", () => {
            it("Then I receive success and the place data", () => __awaiter(void 0, void 0, void 0, function* () {
